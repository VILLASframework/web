  ...
  getLogo(style) {
    ...
    try {
      const logoURL = new URL(
        `./${this.brand}/img/${this.values.logo}`,
        import.meta.url
      ).href;
      image = (
        <img style={style} src={logoURL} alt={"Logo " + this.values.title} />
      );
    } catch (err) {
      console.error(
...
var branding =
  new Branding(import.meta.env.VITE_REACT_APP_BRAND) ??
  new Branding("villasweb");
