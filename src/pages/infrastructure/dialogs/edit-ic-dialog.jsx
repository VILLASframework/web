...
class EditICDialog extends React.Component {
    ...
    if (canceled === false) {
      if (this.valid) {
        ...
        if (
          ...
          this.state.name !== "" &&
          this.state.name !== this.props.ic.name
        ) {
        ...
        if (
          ...
          this.state.location !== this.props.ic.location
        ) {
        ...
        if (
          ...
          this.state.description !== this.props.ic.description
        ) {
        ...
        if (
          ...
          this.state.type !== "" &&
          this.state.type !== this.props.ic.type
        ) {
        ...
        if (
          ...
          this.state.category !== "" &&
          this.state.category !== this.props.ic.category
        ) {
          data.category = this.state.category;
        }

        if (
          this.state.icstate != null &&
          this.state.icstate !== "" &&
          this.state.icstate !== this.props.ic.state
        ) {
          data.state = this.state.icstate;
        }

        if (
          Object.keys(this.state.startparameterschema).length === 0 &&
          this.state.startparameterschema.constructor === Object
        ) {
  ...
  selectStartParamsFile(event) {
    ...
    if (!file.type.match("application/json")) {
      console.error(
        "Not a json file. Will not process file '" + file.name + "'."
      );
      ...
      >
        <Form>
          ...
          <Form.Group controlId="name" style={{ marginBottom: "15px" }}>
            ...
            <Form.Control
              type="text"
              placeholder={this.props.ic.name}
          ...
          <Form.Group controlId="websocketurl" style={{ marginBottom: "15px" }}>
            ...
            <Form.Control
              type="text"
              placeholder={this.props.ic.websocketurl}
          ...
          <Form.Group controlId="apiurl" style={{ marginBottom: "15px" }}>
            ...
            <Form.Control
              type="text"
              placeholder={this.props.ic.apiurl}
          ...
          <Form.Group controlId="location" style={{ marginBottom: "15px" }}>
            ...
            <Form.Control
              type="text"
              placeholder={this.props.ic.location}
          ...
          <Form.Group controlId="description">
            ...
            <Form.Control
              type="text"
              placeholder={this.props.ic.description}
          ...
          <Form.Group controlId="startParameterSchema">
            ...
            <ParametersEditor
              ...
              disabled={true}
            />
            <Form.Label style={{ marginTop: "15px" }} column={false}>
              Select JSON file to update start parameter schema:{" "}
            </Form.Label>
            <Form.Control
              type="file"
              onChange={(event) => this.selectStartParamsFile(event)}
            />
          </Form.Group>
        </Form>
      </Dialog>
